...
let string3 = 'Усвідомлена любов до свого народу не поєднується з ненавистю до інших.';
let string4 = 'Ті, що виїздять за море, міняють небо, а не душу. ';
let string5 = 'Для нас дорогі батьки, дорогі діти, близькі, родичі, але всі уявлення про любов до чого-небудь поєднані в одному слові «вітчизна».';
btn21.onclick = () =>{
